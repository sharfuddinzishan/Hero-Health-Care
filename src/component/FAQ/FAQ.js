    ...
    return (
        <>
            <section class="faq-section p-5">
                <div class="container">
                    <div class="pb-3">
                        <h2 class="section-title lh-1 fs-1 pb-3 fw-normal text-center">Frequently <b>Asked Questions</b></h2>
                        <p class="text-muted fs-6 text-center">We are here to help. Below you will find answers to the questions
                            we get asked the most about our virtual care clinic and the services we offer.</p>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                            <img src="https://gotodoctor.ca/wp-content/uploads/2021/05/illustration-1.svg" class="img-fluid"
                                alt="" />
                        </div>
                        <div class="col-md-9">
